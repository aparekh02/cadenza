"""Minimal LoRA optimizer stub (Community Edition).

The full sensor-driven parameter optimizer (terrain adaptation, speed
adjustment, gait swapping) is available in Cadenza Pro.

This stub passes parameters through unchanged.
"""
